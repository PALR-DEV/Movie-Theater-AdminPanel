                ...
                <nav className="mt-4 px-4 pb-6 flex flex-col h-[calc(100vh-4rem)]">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link
                                to="/screenings"
                                className={`flex items-center rounded-lg px-4 py-3 hover:bg-gray-100 active:bg-gray-200 transition-colors ${isActivePath('/screenings') ? 'bg-gray-100' : ''}`}
                                onClick={() => setIsSidebarOpen(false)}
                            >
                                <span className="text-sm md:text-base">Screenings</span>
                            </Link>
                        </li>
                    </ul>
